    ...
    >
      ...
      >
        ...
        <motion.p
          ...
          className="text-sm text-white/60 tracking-wide text-center"
        >
        ...
        <motion.div
          ...
          className="px-4 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-md text-xs tracking-[0.1em] text-white/70 shadow-[0_0_30px_rgba(255,255,255,0.04)] overflow-hidden"
        >
          <motion.span
            initial={{ width: "0ch" }}
            animate={{ width: "34ch" }}
          ...
          >
            https://swarajthakre26.netlify.app
          </motion.span>
