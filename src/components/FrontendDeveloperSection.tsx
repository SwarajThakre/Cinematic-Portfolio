...
export default function FrontendDeveloperSection() {
  ...
  return (
    <motion.section
      ...
      className="relative flex min-h-0 w-full items-start overflow-hidden bg-black px-4 pt-16 pb-16 text-white select-none md:min-h-screen md:px-20 md:pt-20 md:pb-0"
    >
      {/* TEXT */}
    ...
    animate-[shine_4s_linear_infinite]"
        >
          Hi, I'm <strong className="text-white font-bold">Swaraj Thakre</strong>. I specialize in
          designing and developing premium websites, SaaS platforms, AI-powered applications,
          landing pages, dashboards, and modern digital experiences that solve real business
          problems.
        </motion.p>
      ...
      <AnimatePresence>
        {showCard && (
          ...
          >
            <Suspense
              fallback={
                <div className="absolute right-12 top-28 z-40 px-6 py-3 rounded-full bg-zinc-900/90 border border-white/20 text-white text-xs font-mono tracking-widest uppercase shadow-2xl flex items-center gap-3">
