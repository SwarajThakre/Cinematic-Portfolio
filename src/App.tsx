...
import heroEye from "@/assets/Hero.webp";
          ...
          <div className="min-h-screen bg-black text-white overflow-x-hidden">
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 md:px-12 py-5 backdrop-blur-xl bg-black/20 border-b border-white/10">
              <div className="flex items-center gap-3">
                <img src={favicon} alt="Logo" className="w-8 h-8 rounded-full object-cover" />

                <span className="text-[10px] md:text-xs tracking-[0.3em] text-white/70 uppercase font-medium">
                  SWARAJ · FRONTEND DEVELOPER
                </span>
              </div>
            ...
            >
              <div className="absolute inset-0 flex items-start justify-center pt-20 md:pt-28">
                <img
                  src={heroEye}
                  alt="Portrait of Swaraj Thakre"
                  className="h-[98%] w-[128%] object-contain object-center opacity-80 md:h-[98%] md:w-[98%]"
                />
              </div>
              ...
              <div className="relative z-10 w-full h-full flex flex-col justify-between px-6 md:px-12 pt-24 pb-10">
                <h1
                  ...
                  className={`font-display uppercase leading-[0.85] tracking-[-0.03em] text-[20vw] md:text-[13vw] lg:text-[11rem] cursor-pointer transition-all duration-300 ${colors[colorMode]}`}
                >
                  {displayed || "\u00A0"}
                </h1>
...
animate-[shine_4s_linear_infinite]"
    ...
    animate-[shine_4s_linear_infinite]"
                  ...
                  <a
                    href="https://swarajthakre26.netlify.app/"
                    target="_blank"
